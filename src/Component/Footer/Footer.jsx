...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-[#1E2833] dark:text-white">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                           <BiSolidDonateBlood className="text-7xl text-white animate-bounce"></BiSolidDonateBlood>
                            <span className="self-center text-2xl font-semibold">Life Drop</span>
                        </a>
                    </div>
